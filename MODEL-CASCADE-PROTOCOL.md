...
Each project must maintain the following "Truth" and "State" files:
    ...
    READ-ONLY TRUTHS: TRUTH_*.md (PDD, Datasheet, Spec and any other file with such prefix in the project root).
...
CONTEXT: Project: Wireframe-cli-renderer | Stack: Python3, ncurses
TASK:
